...
function updateTime() {
    ...
    document.getElementById('timeElapsed').innerHTML = currentMinutes + ":" + currentSeconds;
    document.getElementById('timeRemaining').innerHTML = (
        Math.floor((activeSong.duration - activeSong.currentTime) / 60) + ":" +
        (Math.floor((activeSong.duration - activeSong.currentTime) % 60) < 10 ? '0' : '') +
        Math.floor((activeSong.duration - activeSong.currentTime) % 60)
    )
}
